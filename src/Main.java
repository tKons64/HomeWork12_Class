public class Main {
    ...
    public static void printBook2(Book[] arrBooks) {
        for (int i = 0; i < arrBooks.length; i++) {
            ...
            System.out.print(arrBooks[i].getAuthor().getFirstName() + " " + arrBooks[i].getAuthor().getLastName() + ": ");
            System.out.print(arrBooks[i].getTitle() + ": ");
            System.out.println(arrBooks[i].getPublicationYear());
        }
    }

    public static void task2() {
        System.out.println("");
        System.out.println("Задание №2. Средний уровень");
